...
ophu_list = Group(Suppress(Literal('Ophu_List'))+ EQAL + LBRACK + OneOrMore(ophu_stat)+ RBRACK)("ophu_list")
otu_list = Group(Suppress(Literal('OTU_model'))+ EQAL + LBRACK + OneOrMore(ophu_stat)+ RBRACK)("otu_properties")
otu_object=Group(Suppress(Literal('OTU'))+ EQAL + LBRACK + otu_list + ophu_list + RBRACK)("otu_object")
