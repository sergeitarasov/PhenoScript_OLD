...
class phsNode:
    def __init__(self, node_dict, triple_pos='NA', ophu_id='', coord_node='NA'):
    ...
    def strXML(self):
            ...
            return  '<phs:node phs:node_id="%s" phs:triple_pos="%s" phs:node_name="%s">\n%s</phs:node>\n' % (self.node_id, self.triple_pos, self.node_name, props_xml)
